...
1. Вывод кратких результатов нескольких (количество задаётся пользователем в файле 'loter.ini') последних тиражей. Для удобства выполнена обратная сортировка результатов (последний тираж - в первой строке, предпоследний - во второй и т.д.) 
